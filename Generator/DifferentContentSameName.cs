...
";
        ...
        public void Execute(GeneratorExecutionContext context)
        {
            ...
            INamedTypeSymbol attributeSymbol = compilation.GetTypeByMetadataName("DifferentContentSameName.DifferentContentSameNameAttribute");
            ...
            foreach (IGrouping<INamedTypeSymbol, IFieldSymbol> group in fieldSymbols.GroupBy(f => f.ContainingType))
            {
                ...
                context.AddSource($"{group.Key.Name}_DifferentContentSameName.cs", SourceText.From(classSource, Encoding.ASCII));
