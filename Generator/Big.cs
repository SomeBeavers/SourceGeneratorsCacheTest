...
{
    [Generator]
    public class Big : ISourceGenerator
    {
...
namespace Big
{
    ...
    sealed class BigAttribute : Attribute
    {
        public BigAttribute()
        {
        }
...
";
        ...
        public void Execute(GeneratorExecutionContext context)
        {
            ...
            INamedTypeSymbol attributeSymbol = compilation.GetTypeByMetadataName("DifferentContentSameName.DifferentContentDifferentNameAttribute");
            ...
            foreach (IGrouping<INamedTypeSymbol, IFieldSymbol> group in fieldSymbols.GroupBy(f => f.ContainingType))
            {
                ...
                context.AddSource($"{group.Key.Name}_Big.cs", SourceText.From(classSource, Encoding.ASCII));
